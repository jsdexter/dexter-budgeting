    ...
    return (
        <FooterDiv>
            <ButtonContainer>
                ...
                <ModalBill showModal={showModalBill} setShowModal={setShowModalBill}></ModalBill>
                <FooterButton onClick={openModalIncome}>Add Income</FooterButton>
                <ModalIncome showModal={showModalIncome} setShowModal={setShowModalIncome}></ModalIncome>
            </ButtonContainer>
        </FooterDiv>
    );
}
