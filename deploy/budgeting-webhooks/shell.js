...
console.log('This is spartann');
console.log('trying again ANother log statement for testing');
...
handler.on('workflow_run', function (event) {
  ...
  if (repository === REPO_NAME && action === 'completed') {
    ...
    shell.cd('..');
    shell.exec('~/stage/deploy_stage');
    console.log('This is most likely not the finale part 11!!!')
  }
});